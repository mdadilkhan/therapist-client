...
import Sidebar from "./pages/Sidebar/Sidebar.jsx"; // No need to lazy load Sidebar as it is not a heavy component
...
const ClientGroupSessationDetials=lazy(()=> import("./components/GroupSession/ClientGroupSessationDetials.jsx"))
...
const PrivateRoute = ({ allowedRoles }) => {
  ...
  if (!allowedRoles.includes(role)) {
    // Redirect users if they are trying to access the wrong section
    const redirectPath =
        ...
        <Layout>
          <Routes>
            ...
            <Route element={<PrivateRoute allowedRoles={["therapist"]} />}>
              ...
              />
              <Route path="/therapist/supervision/:id?" element={<SuperVisions />} />
              <Route
            ...
            <Route element={<PrivateRoute allowedRoles={["user"]} />}>
              ...
              <Route path="/client/dashboards" element={<ClientDashboard />} />
              <Route
