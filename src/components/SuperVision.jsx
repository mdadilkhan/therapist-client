...
function SuperVision() {
  ...
  const handleSlotClick = (index) => {
    ...
    const slotsRequired = duration / 30; // Number of slots required for the selected duration
  ...
  const handleSubmit = () => {
    ...
    const apiUrl = id
      ? `${API_URL}/rescheduleSupervisionAppointment/${id}`
      : `${API_URL}/bookSupervisionAppointment`;
  ...
  const getAllSuperVision = () => {
    axios
      .get(`${API_URL}/getAllSupervision`)
      .then((res) => {
        if (res.status == 200) {
          setSupervisionList(res.data.data);
        }
      })
      .catch((err) => {
        console.error("Error:", err);
          ...
          <div>
            ...
            <div className="flex gap-1 items-center">
              ...
              <h3 className="body3-sem text-[#6A6A6A]">
                I hereby certify, that i will be taking supervision on the
                aforementioned date
              </h3>
            </div>
            <Button
                        ...
                        <div className="w-full flex flex-col justify-between">
                          ...
                          <div className="flex flex-row flex-wrap py-3 justify-between">
                            <Button
                              ...
                              onClick={() =>
                                navigate(
                                  `/therapist/supervisionList/${item.emp_id}`
                                )
                              }
                            >
                              Reschedule
