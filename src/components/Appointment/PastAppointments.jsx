...
import { getBookingType, getformatedDate } from "../../constant/constatnt";
...
const PastAppointment = () => {
  ...
  const handleCancelAppointment = () => {
    axios
      .post(`${API_URL}/cancelAppointment`, { app_id: modalData })
      .then((res) => {
                            ...
                            .map((row) => {
                              return (
                                ...
                                >
                                  ...
                                  <TableCell align="left" className="body3-reg">
                                    <div>
                                      {getBookingType(row.booking_type)}
                                    </div>
                                  </TableCell>
                                  <TableCell align="left" className="body3-reg">
                                  ...
                                  <TableCell align="left" className="body3-reg">
                                    ...
                                    >
                                      {oldAppointmentStatus[row.booking_status]}
                                    </button>
                                  </TableCell>
                                  <TableCell align="left" className="body3-reg">
                                    <button
